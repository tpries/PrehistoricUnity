...
public class FlyingDino_who : MonoBehaviour
{
    //speed
    ...
    public float flying_threshold = 10;
    ...
    void Update()
    {
        ...
        this.current_speed = forward;
        this.is_flying = this.flying_threshold < this.current_speed;
        animator.SetBool("is_flying", is_flying);
